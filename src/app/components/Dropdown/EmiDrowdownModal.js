...
export default function EmiDrowdownModal({ StdById,idx }) {
  ...
  useEffect(() => {
    // console.log(StdById._id, StdById);  // Access StdById._id
        ...
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
            ...
            {/* <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" onClick={saveEMIChanges}>
                Save Changes
              </button>
            </div> */}
          </div>
