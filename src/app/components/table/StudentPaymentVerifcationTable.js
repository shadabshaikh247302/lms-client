                ...
                <table className="table table-bordered">
                    <thead>
                        <tr style={{ position: "sticky", top: "-1px", zIndex: "1001" }}>
                            ...
                            <th style={{ minWidth: "100px", background: "#b562ff" }}>
                                Dispute
                            </th>
                        </tr>
                    </thead>
                            ...
                            paymentData?.map((payment, index) => {
                                ...
                                return (
                                    <tr
                                        key={payment._id}
                                        style={{
                                            background: payment.isDispute
                                                ? "#ff3434"
                                                : payment.isVerified === "Verified"
                                                    ? "#54ff54"
                                                    : payment.isVerified === "Not Verified"
                                                        ? "#fffa35"
                                                        : "orange",
                                        }}
                                        title={
                                            payment.isDispute
                                                ? `"${student.Name}" raised a Dispute at this Payment record`
                                                : ""
                                        }
                                    >
                                        {/* Sr No */}
